...
def tabu_search(solution, max_iter=60000):
    ...
    for iteration in range(max_iter):
        ...
        #         length_tabu -= 1
            ...
            max_idx, min_idx = sorted_times[random.randint(
                int(k/3),  int(k/2))][0], sorted_times[random.randint(
                    int(k/1.4), k-1)][0]
